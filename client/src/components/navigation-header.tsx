                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-1 mb-6">
                        ...
                        <a href="https://www.willamettevalleybank.com/branch-location/salem" target="_blank" rel="noopener noreferrer" className="block py-2 text-slate-600 hover:text-slate-800 hover:bg-gray-50 rounded px-2 transition-colors text-sm" data-testid="link-locate-commercial-lender">Locate a Commercial Lender</a>
                      </div>
