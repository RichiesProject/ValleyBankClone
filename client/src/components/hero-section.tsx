  ...
  return (
    <section className="bg-slate-800 text-white py-16 relative overflow-hidden" data-testid="hero-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative h-[500px] lg:h-[600px] px-4">
          {/* Far left - Person with skis in winter forest */}
          <div className="absolute left-8 top-16 w-24 h-80 rounded-lg overflow-hidden shadow-lg opacity-90 z-10">
            <img 
          ...
          <div className="absolute left-40 top-0 w-64 h-48 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute left-40 bottom-16 w-64 h-64 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute right-40 top-0 w-64 h-64 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute right-40 bottom-16 w-64 h-48 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute right-8 top-16 w-24 h-80 rounded-lg overflow-hidden shadow-lg opacity-90 z-10">
            <img 
