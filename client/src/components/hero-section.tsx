  ...
  return (
    <section className="bg-slate-800 text-white py-16 relative overflow-hidden" data-testid="hero-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative h-[600px] lg:h-[700px] px-4">
          {/* Far left - Person with skis in winter forest */}
          <div className="absolute left-12 top-24 w-32 h-80 rounded-lg overflow-hidden shadow-lg opacity-90 z-10">
            <img 
          ...
          <div className="absolute left-52 top-8 w-72 h-52 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute left-52 bottom-24 w-72 h-72 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-8 w-[500px] h-[500px] rounded-lg overflow-hidden shadow-xl z-30">
            <img 
          ...
          <div className="absolute right-52 top-8 w-72 h-72 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute right-52 bottom-24 w-72 h-52 rounded-lg overflow-hidden shadow-lg z-20">
            <img 
          ...
          <div className="absolute right-12 top-24 w-32 h-80 rounded-lg overflow-hidden shadow-lg opacity-90 z-10">
            <img 
